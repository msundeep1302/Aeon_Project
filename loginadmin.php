...
Just get a team member to perform the task  and we'll record how they did it. </h5>
        ...
        <div class="col-sm-4">
            <form method="POST" action="">
                ...
                <h3 id="sub1">LOGIN AS ADMIN</h3>
                     <?php 
                       if(@$_GET["msg"]=='adminsuc'){
 ...
 if(isset($_POST['login']))
{
    ...
    else
    {
        ...
        $login="select username,password FROM sign_up_admin WHERE username='$username' AND password='$encrypt_password' ";
...
?>
            ...
            <div class="col-sm-1"></div>
             ...
             <input type="reset"  value="Cancel"  class="btn btn-danger btn-block btn1">
                ...
                <div class="col-sm-6">
             <a href="signupadmin.php" class="btn btn-primary btn-block btn1"><span class="glyphicon glyphicon-user"></span> Sign Up As Admin </a>  
              </div> 
               </div>
              </form>
        </div>
