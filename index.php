          ...
          <div class="col-sm-5">
            <form method="POST" action="" enctype="multipart/form-data">
                <div class="form-group register">
                    ...
                    <h3 id="sub">ENTER YOUR IDENTIFYING INFO</h3>
 <?php
...

{
    ...
    $sql="INSERT INTO index_identifying_info(firstname,lastname,email,instructions) VALUES ('$firstname','$lastname','$email','$instructions')";
    $result= mysql_query($sql);
            echo"Information Submitted Succesfully";
            echo"<br>";
